...
import { Workspace } from '../types/keys';
...
export interface WorkspacesStorage {
     ...
     * });
     */
    update(owner: string, updates: Partial<Omit<Workspace, "owner" | "id">>): Promise<Result<Workspace>>;
    /**
...
declare const workspaces: (redis: Redis | Cluster) => WorkspacesStorage;
